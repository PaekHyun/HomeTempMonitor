...
| 항목 | 내용 |
|------|------|
| MCU | Seeed XIAO ESP32C6 또는 nanoESP32-C6 (ESP32-C6, 160MHz, 512KB SRAM, **4MB 내장 Flash**) |
...
| **nanoESP32-C6** | `HomeTempMonitor_nano.ino` | USB 2개, 배터리 충전 회로 없음 |
...
| 부품 | 수량 | 비고 |
|------|------|------|
| nanoESP32-C6 | 1 | USB 2개 (CH343 + 네이티브) |
